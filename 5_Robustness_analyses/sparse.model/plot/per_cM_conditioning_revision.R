  ...
  stat_test <- df_sub %>%
    ...
    mutate(
      y.position = case_when(
        group2 == "Non-ROH" & group1 == "Short ROH"  ~ 1.5,
        group2 == "Non-ROH" & group1 == "Medium ROH" ~ 0.8,
        group2 == "Non-ROH" & group1 == "Long ROH"   ~ 0.1,
        group1 == "Short ROH"  & group2 == "Medium ROH" ~ -13,
        group1 == "Short ROH"  & group2 == "Long ROH"   ~ -14.8,
        group1 == "Medium ROH" & group2 == "Long ROH"   ~ -13.9,
        TRUE ~ 0.5
      )
    )
...
ggsave(
  filename = paste0('per_cM_conditioning.x.',x,'.pdf'),
...
write.csv(all_stat, paste0('statistical_result_per_cM_conditioning.x.',x,'.csv'), row.names = FALSE)
