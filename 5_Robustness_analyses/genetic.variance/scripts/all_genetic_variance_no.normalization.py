...
# =============================================================================
# Now start the calculation of VA and VD. (before normalization and not centered)
# =============================================================================
...
# ==================================================================================
# Variance expalined by ROH and non-ROH regions. (before normalization and not centered)
# ==================================================================================
...
# =============================================================================
# Now start the calculation of VA and VD. (before normalization and centered)
# =============================================================================
        tsk_cols = [col for col in final_df.columns if col.startswith('tsk_')]
        pheno_cols = [col for col in final_df.columns if col.startswith('pheno_')]
        roh_cols = [col.replace('tsk_', 'roh_') for col in tsk_cols]
        ...
        Sum_Check = V_A + V_D + 2 * Cov_AD - V_G  
# ==================================================================================
# Variance expalined by ROH and non-ROH regions. (before normalization and centered)
# ==================================================================================
        # Variance explained by ROH region
        mask_ROH = (ROH_matrix != 'Non-ROH')        
        ROH_G_sum = np.sum(G_matrix * mask_ROH, axis=0)        
...
all_results_df_uncentered.to_csv(f"variance_partition_summary.{hXX}.{simID}.subset.{x}.uncentered.no.normalization.csv", index=False) 
all_results_df_centered = pd.DataFrame(all_results_list_centered)                
all_results_df_centered.to_csv(f"variance_partition_summary.{hXX}.{simID}.subset.{x}.centered.no.normalization.csv", index=False)               