...
for pop in pop_list:
    ...
    roh_file_path = f'./{hXX}/{simID}/gravel.del.only.{hXX}.{simID}.trees.{pop}.roh.ready.Mb.txt'
...
aggregated_df.to_csv(f"roh_pheno_revision_summary.{hXX}.{simID}.subset.{x}.Mb.csv", index=False)